                	...
                	<div class="entry-content">
                        <div class="coreContent">
                            <div id="productCategories">
                                ...
                                <h4 class="productCategoryTitle term-software"><a href="<?php bloginfo('url'); ?>/product-type/software/">Software</a></h4>
                                <h4 class="productCategoryTitle term-accessories"><a href="<?php bloginfo('url'); ?>/product-type/accessories/">Accessories</a></h4>
                                <h4 class="productCategoryTitle"><a href="<?php bloginfo('url'); ?>/products/">Show All</a></h4>
